...
class RoboticDiffusionTransformerModel(object):
    ...
    def get_text_encoder(self, pretrained_text_encoder_name_or_path):
        text_embedder = T5Embedder(
            from_pretrained="/home/deng_xiang/qian_daichao/RoboTwin/policy/RDT/t5-v1_1-xxl",
    ...
    def get_vision_encoder(self, pretrained_vision_encoder_name_or_path):
        vision_encoder = SiglipVisionTower(vision_tower="/home/deng_xiang/qian_daichao/RoboTwin/policy/RDT/siglip-so400m-patch14-384", args=None)
